...
API_KEY = "M6JQWX970JP"
API_URL = "https://api.2oo9.cloud/M6JQWX970JP/tness/@public/api/getnum"
OTP_API_URL = "https://api.2oo9.cloud/M6JQWX970JP/tness/@public/api/success-otp"
...
def handle_text(message):
    ...
    if message.text == "🎯 Set Range":
        ...
        bot.register_next_step_handler(msg, process_set_range)
        return
